        ...
        editText.setOnKeyListener(new OnKeyListener() {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if ((event.getAction() == KeyEvent.ACTION_DOWN) &&
                     ...
                     * http://developer.android.com/reference/android/os/AsyncTask.html
                     */ // variable msg  becomes msgToSend below
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            while(true) {
                try {
                    ...
                    Log.d(TAG, "Accepted Server Socket");
                    String msgIn;
                    InputStreamReader isr = new InputStreamReader(socket.getInputStream());
                    BufferedReader in = new BufferedReader(isr);
                    //Thread.sleep(1000);
                    msgIn = in.readLine();
                    Log.e(TAG, "msgIn is :  " + msgIn);
                    if (msgIn != null) {
                        publishProgress(msgIn);
                    }
                    else{
                        publishProgress("idk why null");
                    }
                    //publishProgress("not null");
                    //in.close(); // Probably shouldn't do it this way ...
                    //socket.close(); // Probably shouldn't do it this way ...
                /*
            ...
            //return null; // Probably shouldnt do it this way ...
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                // My hacks start here
                Log.e(TAG,"send out message:  "+msgToSend);
                //Log.e(TAG,"socket is :  "+socket);
                //Log.e(TAG,"remotePort is :  "+remotePort);
                // socket.getOutputStream() Returns an output stream for this socket
                //PrintWriter(Writer out, boolean autoFlush) Creates a new PrintWriter true is with autoflush
                OutputStreamWriter osw = new OutputStreamWriter(socket.getOutputStream());
                PrintWriter out = new PrintWriter(new BufferedWriter(osw), true);
                //Log.e(TAG,"socket.getOutputStream is :  "+socket.getOutputStream());
                out.println(msgToSend);
                Log.e(TAG,"Message: "+msgToSend+" sent to other emulator");
                //Log.e(TAG,"out is :  "+out);
                out.flush();
                //Log.e(TAG,"out is :  "+out);
                //out.close(); // Probably shouldnt do it this way ...
                /* 11108 is avd0     11112 is avd1
                 * TODO: Fill in your client code that sends out a message.
                 */

                //socket.close(); // Probably shouldnt do it this way ...
